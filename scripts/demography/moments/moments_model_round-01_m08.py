...
parser = argparse.ArgumentParser(description="Run demographic inference for Tursiops")
parser.add_argument("model_number", help="Model number to specify the model (e.g., '01', '02').")
parser.add_argument("rep_number", help="Repetition number for the model run.")  # REPNUMBER is a string
