#!/usr/bin/env python3
"""
Moments demographic inference for Tursiops, model 7 with expansion - Round 2
...
def get_best_rep_for_model(model_number):
    ...
    summary_file = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_expansion/model_{model_number}_fmin_downSample_summary.csv"
...
BEST_YAML_PATH = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_expansion/output_yaml/model_{MODEL_NUMBER}_rep{BEST_REP}_{METHOD}_downSample.yaml"
...
OUTPUT_PATH = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_expansion/round2/output_yaml/model_{MODEL_NUMBER}_rep{REPNUMBER}_{METHOD}_downSample-Round2.yaml"

OUTPUT_RESULTS_FILE = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_expansion/round2/optimization_model_{MODEL_NUMBER}_{REPNUMBER}_{METHOD}_downSample_results.txt"
PLOT_FILE = f"/home/rbrennan/Tursiops-RAD-popgen/figures/moments/mod7_expansion/round2/round2_optimization_model_{MODEL_NUMBER}_{REPNUMBER}_{METHOD}_downSample.png"
SUMMARY_FILE = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_expansion/round2/model_{MODEL_NUMBER}_{METHOD}_downSample_summary.csv"

# Create output directories
os.makedirs("/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_expansion/round2", exist_ok=True)
os.makedirs("/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_expansion/round2/output_yaml", exist_ok=True)
os.makedirs("/home/rbrennan/Tursiops-RAD-popgen/figures/moments/mod7_expansion/round2/", exist_ok=True)
...
print(f"\nRound 2 complete for mod7_expansion , rep {REPNUMBER}")