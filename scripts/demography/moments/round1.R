...
for (k in 1:8){
  data <- read_delim(paste0("analysis/moments/round1/model_0",k,"_fmin_downSample_summary.csv"),
...
ggsave("figures/moments/round-1_logLikelihoods.pdf", p, h=4, w=5)
...
# then add all results to this
for (k in 1:8){
  data <- read_delim(paste0("analysis/moments/initialRuns/model_0",k,"_fmin_downSample_summary.csv"),
                     show_col_types = FALSE,
                     delim=",")
