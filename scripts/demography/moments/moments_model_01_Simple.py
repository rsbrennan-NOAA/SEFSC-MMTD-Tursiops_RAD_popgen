...
output = "/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/model_01-bestfit_fmin.yaml"
...
# save to file
with open("optimization_model_01_results.txt", "w") as f:
...
try:
     ...
     plt.savefig("demes_model_01.png", dpi=300)
