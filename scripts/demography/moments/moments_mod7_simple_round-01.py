#!/usr/bin/env python3
"""
Moments demographic inference for Tursiops populations - Model 07- simple
"""
...
parser = argparse.ArgumentParser(description="Run demographic inference for model 7 with no expansion for coastal.")
...
for deme in yaml_data['demes']:
    if deme['name'] == 'Ancestor':
        ...
        # This deme likely needs start_time and proportions updated
