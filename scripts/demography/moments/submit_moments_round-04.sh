...
#SBATCH --time=7-00
#SBATCH --array=81-160%20  # 8 models × 10 reps = 80 total jobs
...
python -u ~/Tursiops-RAD-popgen/scripts/demography/moments/moments_model_round-04_allSFS.py $MODEL_NUMBER $REP_NUMBER