...
#SBATCH --time=7-00
#SBATCH --array=1-160%20  # 8 models × 10 reps = 80 total jobs
...
python -u ~/Tursiops-RAD-popgen/scripts/demography/moments/moments_model_round-03_plus.py $MODEL_NUMBER $REP_NUMBER $ROUND_NUMBER $PERTURB $MAXITER $METHOD $SFS_FILE