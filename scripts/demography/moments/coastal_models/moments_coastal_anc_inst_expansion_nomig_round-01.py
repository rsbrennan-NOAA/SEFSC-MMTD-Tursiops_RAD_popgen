...
split1_val = int(np.random.uniform(500, 20000))
expansion_time_val = int(np.random.uniform(split1_val, 30000))
bottleneck_time_val = int(np.random.uniform(expansion_time_val, 50000))
...
for deme in yaml_data['demes']:
    if deme['name'] == 'Ancestor':
        ...
        # Epoch 2: instant expansion
        deme['epochs'][2]['end_time'] = split1_val
        deme['epochs'][2]['start_size'] = n_coastal_expansion  
