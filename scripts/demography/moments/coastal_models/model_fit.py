...
MODEL="coastal"
SUM_NAME="coastal_fmin_summary.csv"
...
BEST_REP="15"
INPUT_DIR="/home/rbrennan/Tursiops-RAD-popgen/analysis/moments"
MODEL="coastal_pop_expansion"
SUM_NAME="coastal_pop_expansion_fmin_summary.csv"
...
for i, pop_name in enumerate(pop_names):
    ...
    # Save each plot individually
    plt.savefig(f"/home/rbrennan/Tursiops-RAD-popgen/figures/model_fit/model_coastal_pop_expansion_{pop_name}_comparison.png", dpi=300, bbox_inches='tight')
    plt.show()
