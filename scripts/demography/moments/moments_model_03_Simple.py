...
# define file paths
deme_graph = "/home/rbrennan/Tursiops-RAD-popgen/scripts/demography/moments/fourpop_03_Admix_GulfCoast.yaml"
options = "/home/rbrennan/Tursiops-RAD-popgen/scripts/demography/moments/options_fourpop_03_Simple.yaml"
output = "/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/model_03-bestfit_fmin.yaml"
...
# save to file
with open("optimization_model_03_results.txt", "w") as f:
...
try:
     ...
     plt.savefig("demes_model_03.png", dpi=300)
