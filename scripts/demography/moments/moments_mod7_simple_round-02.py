#!/usr/bin/env python3
"""
Moments demographic inference for Tursiops, model 7 with NO expansion - Round 2
...
def get_best_rep_for_model(model_number):
    ...
    summary_file = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_simple/model_{model_number}_fmin_downSample_summary.csv"
...
BEST_YAML_PATH = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_simple/output_yaml/model_{MODEL_NUMBER}_rep{BEST_REP}_{METHOD}_downSample.yaml"
OPTIONS_PATH = f"/home/rbrennan/Tursiops-RAD-popgen/scripts/demography/moments/options_fourpop_{MODEL_NUMBER}_Simple.yaml"
OUTPUT_PATH = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_simple/round2/output_yaml/model_{MODEL_NUMBER}_rep{REPNUMBER}_{METHOD}_downSample-Round2.yaml"

OUTPUT_RESULTS_FILE = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_simple/round2/optimization_model_{MODEL_NUMBER}_{REPNUMBER}_{METHOD}_downSample_results.txt"
PLOT_FILE = f"/home/rbrennan/Tursiops-RAD-popgen/figures/moments/mod7_simple/round2/round2_optimization_model_{MODEL_NUMBER}_{REPNUMBER}_{METHOD}_downSample.png"
SUMMARY_FILE = f"/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_simple/round2/model_{MODEL_NUMBER}_{METHOD}_downSample_summary.csv"

# Create output directories
os.makedirs("/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_simple/round2", exist_ok=True)
os.makedirs("/home/rbrennan/Tursiops-RAD-popgen/analysis/moments/mod7_simple/round2/output_yaml", exist_ok=True)
os.makedirs("/home/rbrennan/Tursiops-RAD-popgen/figures/moments/mod7_simple/round2/", exist_ok=True)
...
print(f"\nRound 2 complete for mod7_simple , rep {REPNUMBER}")