...
vcftools --gzvcf ${INDIR}/filtered.6.vcf.gz --max-meanDP 137 --exclude-positions ~/Tursiops-NC-PopulationAssignment-RAD/scripts/HD_exclude.txt --recode --recode-INFO-all --stdout |  bgzip > ${INDIR}/filtered.final.vcf.gz
